    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="card p-3 py-4">
                ...
                <div class="text-center">
                    <img src="{{asset('/assets/user-image/'. $profile->image)}}" width="100" class="rounded-circle">
                </div>
                ...
                <div class="text-center mt-3">
                    ...
                    <a href="{{asset('assets/cvs/cv.pdf')}}" class="btn btn-warning btn-block">Download CV</a>
                    <div class="px-4 mt-1">
